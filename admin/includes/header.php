    ...
    <div class="main-content" id="main-content">
        ...
        <header class="topbar" id="topbar">
            <div class="d-flex align-items-center">
                ...
                <h5 class="m-0 h5 fw-bold text-dark d-none d-sm-block">Dashboard</h5>
            </div>
            ...
            <div class="dropdown">
                <a class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle profile-toggle" href="#"
                    ...
                    <div class="me-3 text-end d-none d-md-block">
                        <span class="d-block fw-bold" style="font-size: 0.9rem; line-height: 1.2;"><?php echo isset($_SESSION['admin_name']) ? $_SESSION['admin_name'] : 'Admin'; ?></span>
                        <span class="d-block text-primary fw-medium" style="font-size: 0.75rem;">Administrator</span>
                    </div>
                    <div class="profile-img-wrapper" style="position: relative;">
                        <img src="https://ui-avatars.com/api/?name=<?php echo urlencode(isset($_SESSION['admin_name']) ? $_SESSION['admin_name'] : 'Admin'); ?>&background=4361ee&color=fff&bold=true"
                ...
                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg p-2 mt-2" aria-labelledby="userDropdown" style="border-radius: 15px; min-width: 200px;">
                    <li><h6 class="dropdown-header text-xs text-uppercase fw-bold text-muted pb-2">User Menu</h6></li>
                    ...
                    <li><a class="dropdown-item rounded-3 py-2" href="settings.php"><i class="fas fa-shield-alt me-2 text-primary"></i> Security</a></li>
