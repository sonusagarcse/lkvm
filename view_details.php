      ...
      <div class="col-lg-12 col-md-12 col-sm-12 about_cont_blog">
        <div class="full text_align_left">
		  ...
		  <style>
		   ...
		   <div class="textdb" style="overflow:scroll;">
			
					
 		 <?php 
		 $did=$_REQUEST['did'];
		 $status=1;
		$sel=$con->prepare("select * from photos where id=? and status=? order by id DESC");
		$sel->bind_param("ii", $did, $status);
		$sel->execute();
		$res=$sel->get_result()->fetch_object();
		?>
		 <div class="col-md-12">
		 
		 <iframe src="images/photos/<?php echo $res->img;?>#toolbar=0&navpanes=0" style="width:100%;height:600px;"> 
