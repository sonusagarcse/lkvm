...
<div class="row ">
		  <?php 
		  $status = 1;
		  $sel = $con->prepare("SELECT * FROM photo_category WHERE status = ? ORDER BY id DESC");
		  ...
		  ?>
		 <div class="col-md-3">
		  <a class="example-image-link" href="<?php echo $SITE_URL;?>/view_photos?pcid=<?php echo $res['id'];?>" data-lightbox="example-set">
		  <div class="img-box" style="background:#CCCCCC; border: dotted 2px #000; padding:20px; height:170px;">
		  <center>
		  <img src="images/imgicon.png" style="width:80px; height:80px;" >
         ...
         <?php 
		          ...
		          echo "<div class='col-md-12'><p>No photo categories available at the moment.</p></div>";
		      }
		  } else {
		      echo "<div class='col-md-12'><p>Unable to load photo categories. Please try again later.</p></div>";
		  }
		  ?>
		 </div>
