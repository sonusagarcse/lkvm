			...
			<div class="entry-banner">
				<div class="container">
					<div class="entry-banner-content">
						<h1 class="entry-title">Media Room</h1>
							...
							<div class="entry-breadcrumb"><!-- Breadcrumb NavXT 7.2.0 -->
								<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage"
									...
									<meta property="position" content="1">
										...
										class="post post-page current-item">Media Room</span>
																							...
																							<div class="img-box"
																								...
																								<center>
																									<a class="example-image-link"
																										href="images/photos/<?php echo $res['img']; ?>"
																										data-lightbox="example-set">
																										<img src="images/photos/<?php echo $res['img']; ?>"
																											class="img-responsive1"
																											style="width:100%; height:auto; border: solid 5px #fff;">
																									</a>
																								</center>
																							</div>
																						</div>
