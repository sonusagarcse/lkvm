...
<head>
	...
	<?php
	$pcid = (int) $_REQUEST['pcid']; // Sanitize input
	$status = 1;
	// Prepare the query correctly for MySQLi
	$sel = $con->prepare("SELECT * FROM photo_category WHERE id = ? AND status = ? ORDER BY id DESC");
	$sel->bind_param("ii", $pcid, $status);
	$sel->execute();
	$result = $sel->get_result();
	$res_4 = $result->fetch_assoc();
	?>
			...
			<div class="entry-banner">
				<div class="container">
					<div class="entry-banner-content">
						<h1 class="entry-title"><?php echo htmlspecialchars($res_4['name']); ?></h1>
							...
							<div class="entry-breadcrumb"><!-- Breadcrumb NavXT 7.2.0 -->
								<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage"
									...
									<meta property="position" content="1">
										...
										class="post post-page current-item"><?php echo htmlspecialchars($res_4['name']); ?></span>
													...
													<div class="wpb_wrapper">
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																...
																<div class="row ">
																	<div
																		class="col-lg-12 col-md-12 col-sm-12 about_cont_blog">
																		<div class="full text_align_left">
																			<div class="row ">
																				<link rel="stylesheet"
																					href="css/lightbox.min.css">
																				<script
																					src="js/lightbox-plus-jquery.min.js"></script>
																				<?php 
		$stan=1;
		$sel=$con->prepare("select * from photos where cid=? and status=? order by id DESC");
		$sel->bind_param("ii", $pcid, $stan);
		$sel->execute();
		$result = $sel->get_result();
