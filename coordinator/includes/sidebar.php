...
<nav class="sidebar glass-panel" id="sidebar">
    ...
    <div class="sidebar-nav-wrapper">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo in_array(basename($_SERVER['PHP_SELF']), ['emp_manage.php', 'emp_attendance_upload.php', 'emp_salary_slips.php', 'emp_slip_history.php']) ? '' : 'collapsed'; ?>" data-bs-toggle="collapse" href="#employeeCollapse" role="button" aria-expanded="<?php echo in_array(basename($_SERVER['PHP_SELF']), ['emp_manage.php', 'emp_attendance_upload.php', 'emp_salary_slips.php', 'emp_slip_history.php']) ? 'true' : 'false'; ?>" aria-controls="employeeCollapse" style="display: flex; align-items: center;">
                <i class="fas fa-users-cog"></i>
                <span class="ms-1">Employee System</span>
                <i class="fas fa-chevron-down ms-auto" style="font-size: 0.8em; margin-left: auto;"></i>
            </a>
            <div class="collapse <?php echo in_array(basename($_SERVER['PHP_SELF']), ['emp_manage.php', 'emp_attendance_upload.php', 'emp_salary_slips.php', 'emp_slip_history.php']) ? 'show' : ''; ?>" id="employeeCollapse">
